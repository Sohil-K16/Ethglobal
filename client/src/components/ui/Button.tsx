...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-purple-600 to-blue-600 text-primary-foreground shadow hover:from-purple-700 hover:to-blue-700 hover:scale-105",
        destructive:
        ...
        success: "bg-green-600 text-white shadow hover:bg-green-700 hover:scale-105",
        warning: "bg-yellow-600 text-white shadow hover:bg-yellow-700 hover:scale-105",
      },
      size: {
